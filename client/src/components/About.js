...
function About() {
  ...
  return (
    <form
      method="GET"
      className="md:w-3/4 md:h-[500px] md:pt-10 md:mt-24 md:ml-48 md:flex justify-around shadow-black-200 tracking-wider border-black border-2 rounded-3xl shadow-lg shadow-indigo-500/40"
    >
      ...
      <div className="">
        <div className="flex flex-row justify-between md:w-96 md:h-48">
          <div className="font-bold">
            <h4 className="text-3xl ">{userData.name}</h4>
            <p className="text-xl text-sky-600">{userData.work}</p>
            <p>Ranking: 1/10</p>
          </div>
